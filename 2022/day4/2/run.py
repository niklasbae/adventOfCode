...
for element in inputList:
    ...
    if firstPairFirstNumber <= secondPairFirstNumber and firstPairSecondNumber >= secondPairSecondNumber:
        ...
        counter += 1
    elif firstPairFirstNumber <= secondPairFirstNumber and firstPairSecondNumber >= secondPairFirstNumber and firstPairSecondNumber <= secondPairSecondNumber:
        counter += 1
    elif secondPairFirstNumber <= firstPairFirstNumber and secondPairSecondNumber >= firstPairFirstNumber and secondPairSecondNumber <= firstPairSecondNumber:
        counter += 1
